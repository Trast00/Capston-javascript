const countMovies = require('./src/modules/CountMovies.js');
const ListMovies = require('./src/modules/ListMovies.js');
...
const movie = {
  ...
  weight: 98,
  network: {
    id: 2, name: 'CBS', country: { name: 'United States', code: 'US', timezone: 'America/New_York' }, officialSite: 'https://www.cbs.com/',
  },
  webChannel: null,
  dvdCountry: null,
